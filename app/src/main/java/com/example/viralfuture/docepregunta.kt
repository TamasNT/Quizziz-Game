...
class docepregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_docepregunta)
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMilliseconds, 1000) {
            ...
            override fun onFinish() {
                ...
                val i = Intent(applicationContext, trecepregunta::class.java)
                startActivity(i)
            }
        }
    ...
    fun GoToTrecePregunta (view: View){
