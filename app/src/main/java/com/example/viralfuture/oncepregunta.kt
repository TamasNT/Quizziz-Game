...
class oncepregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_oncepregunta)
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMilliseconds, 1000) {
            ...
            override fun onFinish() {
                ...
                val i = Intent(applicationContext, docepregunta::class.java)
                startActivity(i)
            }
        }
    ...
    fun pista(view: View) {
        ...
        if(view.id == R.id.pista){
            ...
            Toast.makeText(applicationContext,"Es rojo, divertido y usa armas de fuego", Toast.LENGTH_SHORT).show()
        }
    }

    // Metodo para cambiar de vista al presionar el boton
    fun GoToDocePregunta (view: View){
        if(nombreenviado){
            if(nombre.lowercase()=="deadpool") {
                BaseDatos.Correctas++
                BaseDatos.Puntuacion++
