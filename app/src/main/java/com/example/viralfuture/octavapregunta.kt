...
class octavapregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_octavapregunta)
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMilliseconds, 1000) {
            ...
            override fun onFinish() {
                if(nombre.lowercase() == "vibranium" || nombre.lowercase() == "vibranio") {
                    BaseDatos.Correctas++
                ...
                val i = Intent(applicationContext, Puntaje::class.java)
                startActivity(i)
            }
        }
    ...
    fun pista(view: View) {
        ...
        if(view.id == R.id.pista){
            ...
            Toast.makeText(applicationContext,"Es un metal de origen extraterrestre", Toast.LENGTH_SHORT).show()
        }
    }

    // Metodo para cambiar de vista al presionar el boton
    fun GoToInicio(view: View) {
        if(nombreenviado){
            if (nombre.lowercase() == "vibranium" || nombre.lowercase() == "vibranio") {
                BaseDatos.Correctas++
                BaseDatos.Puntuacion++
