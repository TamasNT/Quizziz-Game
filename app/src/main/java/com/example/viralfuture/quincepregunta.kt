...
class quincepregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quincepregunta)
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMilliseconds, 1000) {
            ...
            override fun onFinish() {
                if (Opcion3.isChecked && Opcion1.isChecked) {
                    BaseDatos.Correctas++
                ...
                val i = Intent(applicationContext, dieciseispregunta::class.java)
                startActivity(i)
            }
        }
    ...
    fun GoToDieciseisPregunta(view: View) {
        if (Opcion3.isChecked && Opcion1.isChecked) {
            BaseDatos.Correctas++
            BaseDatos.Puntuacion++
        }else{
