...
class septimapregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_septimapregunta)
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMilliseconds, 1000) {
            ...
            override fun onFinish() {
                ...
                val i = Intent(applicationContext, octavapregunta::class.java)
                startActivity(i)
            }
        }
    ...
    fun GoToOctavaPregunta(view: View) {
