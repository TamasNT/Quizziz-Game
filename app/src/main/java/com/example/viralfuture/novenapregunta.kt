...
class novenapregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_novenapregunta)
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMilliseconds, 1000) {
            ...
            override fun onFinish() {
                ...
                val i = Intent(applicationContext, decimapregunta::class.java)
                startActivity(i)
            }
        }
    ...
    fun pista(view: View) {
        ...
        if(view.id == R.id.pista){
            ...
            Toast.makeText(applicationContext,"Elemento radiactivo nativo de su planeta", Toast.LENGTH_SHORT).show()
        }
    }

    // Metodo para cambiar de vista al presionar el boton
    fun GoToDecimaPregunta (view: View){
