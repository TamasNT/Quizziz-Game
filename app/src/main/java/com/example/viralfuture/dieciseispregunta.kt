...
class dieciseispregunta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dieciseispregunta)
    ...
    fun pista(view: View) {
        ...
        if(view.id == R.id.pista){
            ...
            Toast.makeText(applicationContext,"Empieza con F y termina con h", Toast.LENGTH_SHORT).show()
        }
    }
